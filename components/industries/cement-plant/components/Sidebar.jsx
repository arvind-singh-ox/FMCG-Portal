...
const icons = {
  ...
  'robotics-hub': (color) => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2v4m0 12v4M4.93 4.93l2.83 2.83m8.48 8.48l2.83 2.83M2 12h4m12 0h4" /><circle cx="12" cy="12" r="4" />
    </svg>
  ),
  settings: (color) => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const menuStructure = [
  {
    ...
    children: [
      ...
      { key: 'digital-twin-monitoring', label: 'Digital Twin Monitoring' },
      { key: 'ai-insights', label: 'AI Insights Summary' },
    ],
  },
  {
    key: 'ai-vision', label: 'AI Vision & Predictive Analytics',
    children: [
      { key: 'kiln-optimization', label: 'Kiln Process Optimization' },
      { key: 'conveyor-health', label: 'Conveyor Belt Health' },
      { key: 'raw-material', label: 'Raw Material & Fuel Blend' },
      { key: 'quality-prediction', label: 'Quality Prediction & Control' },
      { key: 'emission-monitoring', label: 'Emission Monitoring' },
      { key: 'inventory-logistics', label: 'Inventory & Logistics' },
  ...
  {
    key: 'robotics-hub', label: 'Robotics & Automation',
    children: [
      { key: 'robotics', label: 'Robot Control Center' },
      { key: 'static-arms', label: 'Static Arms — Live' },
      { key: 'palletizing', label: 'Palletizing Ops' },
      { key: 'mobile-robots', label: 'Mobile Robots' },
    ],
  },
  {
    key: 'predictive-maintenance', label: 'Predictive Maintenance',
    children: [
      { key: 'asset-health', label: 'Critical Asset Health' },
  ...
  },
  {
    ...
    children: [
      { key: 'env-compliance', label: 'Environmental Dashboard' },
  ...
  {
    key: 'settings', label: 'Platform Administration',
    children: [
...
function Sidebar({ collapsed, onToggle, activeItem, onItemClick }) {
  ...
  return (
    <>
      {/* Collapse / Expand toggle — always visible, pinned to sidebar edge */}
      <button
        style={{ ...styles.collapseBtn, left: collapsed ? '48px' : '238px' }}
        onClick={onToggle}
      >
      ...
      <div style={{ ...styles.sidebar, width: collapsed ? '60px' : '250px' }}>
        <div style={styles.logoSection}>
          ...
          {!collapsed && (
            <div style={styles.brandBlock}>
              <span style={styles.brandName}>Cement Plant</span>
